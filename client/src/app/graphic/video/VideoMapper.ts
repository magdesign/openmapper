...
export class VideoMapper {
    ...
    /**
     * creates a new IVideoMaterial Mapper Object at the given startPoint.
     * @param video htmlVideo source
     * @param startPoint on the screen
     */
    ...
    private static addDragHandles(videoMaterial: IVideoMaterial): void {
        ...
        [
            DragHandler.createEdges(videoMaterial.positions, DragHandlerTypes.Mapper, VideoMaterialBuilder.dragVideo(videoMaterial)),
